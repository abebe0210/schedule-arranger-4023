...
const GITHUB_CLIENT_ID = process.env.GITHUB_CLIENT_ID || 'Ov23li38BYIxuTZha1zQ';
const GITHUB_CLIENT_SECRET = process.env.GITHUB_CLIENT_SECRET || '3510afb92a1db8cb13b8704405195f5a71225c69';
